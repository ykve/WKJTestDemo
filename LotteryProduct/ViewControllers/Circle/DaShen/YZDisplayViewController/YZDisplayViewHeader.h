...
// 标题缩放比例
static CGFloat const YZTitleTransformScale = 0;

// 下划线默认高度
static CGFloat const YZUnderLineH = 2;

#define YZScreenW [UIScreen mainScreen].bounds.size.width
#define YZScreenH self.view.bounds.size.height + 49//[UIScreen mainScreen].bounds.size.height

// 默认标题字体
#define YZTitleFont [UIFont systemFontOfSize:15]
#define YZSelectedTitleFont [UIFont boldSystemFontOfSize:15]
