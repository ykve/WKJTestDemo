...
+(NSDate *)datebeforeYear:(int)year {
    ...
    NSCalendar *calendar = [NSCalendar currentCalendar];
    NSDateComponents *componentsTodel = [[NSDateComponents alloc] init];
    [componentsTodel setYear:year];
    NSDate *dateAfterYear = [calendar dateFromComponents:componentsTodel];
