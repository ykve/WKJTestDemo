...
-(void)setUpUIColor
{
    ...
    self.ybgColor = [UIColor clearColor];
    self.xbgColor = [UIColor clearColor];
...
-(void)drawChartView
{
    ...
    {
        if ([subLayer isKindOfClass:[UILabel layerClass]]== NO) {
...
//        [path addLineToPoint:CGPointMake(point.x, (CGRectGetHeight(self.bgView.frame) -  _bottomMargin))];
//
           ...
           CGPathAddLineToPoint(dotteShapePath, NULL, point.x, (CGRectGetHeight(self.bgView.frame) -  _bottomMargin));
           [dotteShapeLayer setPath:dotteShapePath];
           CGPathRelease(dotteShapePath);
           [self.bgView.layer addSublayer:dotteShapeLayer];
       }
    }
...
- (void)drawXYLabels{
    ...
    for(int i = 0; i <= _yCount; i ++)
    {
        UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(0,(_topMargin-_everyH * 0.5 - 4)+i*_everyH, _leftMargin-2, _everyH)];
        
        lbl.backgroundColor = self.ybgColor;
    ...
    UILabel *lab = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.bgView.frame) - _bottomMargin, _leftMargin, _bottomMargin)];
    
    lab.backgroundColor = self.xbgColor;
    ...
    lab.text = self.typestr;
    
    [self addSubview:lab];
    
    UILabel *lab2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, _leftMargin, _bottomMargin)];
    
    lab2.backgroundColor = self.ybgColor;
    
    lab2.textColor = self.yColor;
    ...
    for(int i = 0; i < _xCount; i ++){
        ...
        lbl.backgroundColor = self.xbgColor;
