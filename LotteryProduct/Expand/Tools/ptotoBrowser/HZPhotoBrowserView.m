...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    {//WiFi网络下下载原图
        ...
        [self loadWithurl:url Withholdimage:placeholder];
    }
    else
    {//手机自带网络
        if (wifi)//手机自带网络，
...
-(void)loadWithurl:(NSURL *)url Withholdimage:(UIImage *)placeholder {
    
    __weak __typeof(self)weakSelf = self;
//    [_imageview yy_setImageWithURL:url placeholder:NOPHOTO options:YYWebImageOptionShowNetworkActivity progress:^(NSInteger receivedSize, NSInteger expectedSize) {
