...
#import "DigitsLineCtrl.h"
#import "SSQTrendLayout.h"
#import "SSQTrendIssueCell.h"
#import "SSQTrendNumberCell.h"
#import "SSQTrendModel.h"
#import "StatisticsModel.h"
@interface DigitsLineCtrl ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (UIScrollView *)ballsPagView{
    ...
    if (!_ballsPagView) {
        ...
        NSArray *balls = [self getNumberListFrom:0 count:10 isAuto:YES];
        _ballsPagView = [[UIScrollView alloc] initWithFrame:CGRectMake(kIssueListWidth + 1, 0, SCREEN_WIDTH - kIssueListWidth - 1, kItemSize.height)];
...
- (UITableView *)issueList{
    ...
    if (!_issueList) {
        ...
        _issueList = [[UITableView alloc] initWithFrame:CGRectMake(0, kItemSize.height, kIssueListWidth, SCREEN_HEIGHT - kItemSize.height - NAV_HEIGHT- 34 - 44) style:UITableViewStylePlain];
...
- (UICollectionView *)numberList{
    ...
    if (!_numberList) {
        ...
        layout.cols = 10;
        _numberList = [[UICollectionView alloc] initWithFrame:CGRectMake(kIssueListWidth + 1, kItemSize.height, SCREEN_WIDTH - kIssueListWidth - 1, SCREEN_HEIGHT - kItemSize.height - NAV_HEIGHT- 34 - 44) collectionViewLayout:layout];
